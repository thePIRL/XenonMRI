...
class FlipCal:
    ...
    def draw_wiggles(self,axb):
        try:
            ...
            axb.plot(np.linspace(100*int(self.scanParameters['TR'])*1e-6,int(self.scanParameters['TR'])*len(self.RBC2MEMsig_wiggles)*1e-6,len(self.RBC2MEMsig_wiggles[100:])), self.RBC2MEMsig_wiggles[100:])
            axb.plot(np.linspace(100*int(self.scanParameters['TR'])*1e-6,int(self.scanParameters['TR'])*len(self.RBC2MEMmag_wiggles)*1e-6,len(self.RBC2MEMmag_wiggles[100:])), self.RBC2MEMmag_wiggles[100:])
            axb.plot(np.linspace(100*int(self.scanParameters['TR'])*1e-6,int(self.scanParameters['TR'])*len(self.RBC2MEMdix_wiggles)*1e-6,len(self.RBC2MEMdix_wiggles[100:])), self.RBC2MEMdix_wiggles[100:])
            axb.set_ylim([0,1])
            ...
            axb.text(2,0.95,f"RBC/MEM signal = {np.round(np.mean(self.RBC2MEMsig_wiggles[100:]),3)}",fontsize=11,color='#1f77b4')
            axb.text(2,0.90,f"RBC/MEM magnitude = {np.round(np.mean(self.RBC2MEMmag_wiggles[100:]),3)}",fontsize=11,color='#ff7f0e')
            axb.text(2,0.85,f"RBC/MEM dixon = {np.round(np.mean(self.RBC2MEMdix_wiggles[100:]),3)}",fontsize=11,color='#2ca02c')
